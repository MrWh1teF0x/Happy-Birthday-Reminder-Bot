...
ABOUT_TEXT = (
    "🎉 Привет! Я — твой личный главный по праздникам!\n"
    "\n"
    "Больше никаких забытых дней рождения, паники в последний момент и неловких оправданий! "
    "Я буду заранее напоминать о важных датах, чтобы ты всегда успевал подготовить "
    "отличный подарок и поздравить близких первым.\n"
    "\n"
    "✨ Чем я могу помочь:\n"
    "\n"
    "- 📅 Запомню даты всех твоих друзей, родных и коллег\n"
    "\n"
    "- 🔔 Заблаговременно напомню о празднике (за неделю, 3 дня или с самого утра)\n"
    "\n"
    "- 🎁 Сохраню твои заметки и идеи для подарков"
    "\n\n" + HELP_HINT
)
